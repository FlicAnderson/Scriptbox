## Padme Output  :: script_dataGrabFullLatLonOrGazLatLon_Oman.R
# ==============================================================================
# (30th September 2015)
# Author: Flic Anderson
#
# dependent on: "O://CMEP\ Projects/Scriptbox/database_connections/function_livePadmeArabiaCon.R"
# saved at: O://CMEP\ Projects/Scriptbox/database_output/script_dataGrabFullLatLonOrGazLatLon_Oman.R
# source: source("O://CMEP\ Projects/Scriptbox/database_output/script_dataGrabFullLatLonOrGazLatLon_Oman.R")
#
# AIM: Pull out records into R for species in Oman for counting & assessing from 
...
# show what the issues are: 
  # (droplevels removes all recIDs with 0 count)
  # > table(droplevels(dups$recID))
  # 
  # L-15326 L-15332 L-15351 L-15355 L-15367 L-15371 L-15372 
  # 2       2       2       2       2       2       2 
  # L-15380 L-15381 L-15384 L-15396 
  # 2       2       4       2 
